...
def p_conditional_statement_1(t):
	...
	t[0].code += t[5].code + str(labels+3) + ":\n"
	labels = labels + 3
	t[0].next = str(labels)
	pass
...
def p_conditional_statement_2(t):
	...
	t[0].code = t[3].code + "\n" + str(labels)  + ": " + t[3].type + "const_0 \n" + str(labels+1) + ": " + t[3].type + "load " + t[3].place + "\n"
	t[0].code += str(labels+2) + ": if_icmple " + str(labels+3) + "\n"
	t[0].code += t[6].code + str(labels+3) + ":\n"
	labels = labels + 3
	t[0].next = str(labels)
	pass
...
def p_print_function_1(t):
	...
	t[0].code += t[3].place + "\n" + str(labels+2) + ": invokevirtual java/io/PrintStream.println(I)V\n"
	labels += 2
	t[0].next = t[3].next
...
def p_main_function_1(t):
	...
	global labels
	labels += 1
	t[0].code = str(labels) + ": .method public static name([Ljava/lang/String;)V\n"
