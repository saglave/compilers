...
def p_iterative_statement_5(t):
	...
	global labels
	labels += 1
	t[0].code = str(labels) + ": " + t[3].code + str(labels+1) + ": " + t[3].type + "load " + t[3].place + "\n"
	t[0].code += str(labels+2) + ": ifle " + str(labels+4) + "\n"
...
def p_iterative_statement_9(t):
	...
	global labels
	labels += 1 
	t[0].code = str(labels) + ": " + t[2].code + t[5].code + str(labels+1) + ": " + t[5].type + "load " + t[5].place + "\n"
	t[0].code += str(labels+2) + ": ifle " + str(labels) + "\n" 
	labels += 2
	t[0].next = t[5].next
	pass
...
def p_iterative_statement_10(t):
	...
	global labels
	labels += 1
	t[0].code = str(labels) + ": " + t[3].code + t[7].code + str(labels+1) + ": " + t[7].type + "load " + t[7].place + "\n"
	t[0].code += str(labels+2) + ": ifle " + str(labels) + "\n" 
	labels += 2
	t[0].next = t[7].next
	pass
...
def p_iterative_statement_11(t):
	...
	t[0].code += str(labels+1) + ": ifle " + str(labels) + "\n" 
	labels += 1
	t[0].next = t[5].next
	pass
...
def p_conditional_statement_1(t):
	...
	t[0].code += str(labels+2) + ": if_icmple " + str(labels+3) + "\n"
	t[0].code += t[5].code + str(labels+3) + ": iinc 0 0\n"
	labels = labels + 3
	t[0].next = str(labels)
	pass
...
def p_conditional_statement_2(t):
	...
	t[0].code = t[3].code + "\n" + str(labels)  + ": " + t[3].type + "const_0 \n" + str(labels+1) + ": " + t[3].type + "load " + t[3].place + "\n"
	t[0].code += str(labels+2) + ": if_icmple " + str(labels+3) + "\n"
	t[0].code += t[6].code + str(labels+3) + ": iinc 0 0\n"
	labels = labels + 3
	t[0].next = str(labels)
	pass
...
def p_conditional_statement_3(t):
	...
	labels += 1
	t[0].code = t[3].code + "\n" + str(labels)  + ": " + t[3].type + "const_0 \n" + str(labels+1) + ": " + t[3].type + "load " + t[3].place + "\n"
	t[0].code += str(labels+2) + ": if_icmple " + str(labels+4) + "\n"
	t[0].code += t[5].code + str(labels+3) +  ": goto " + str(labels+5) + "\n"
	t[0].code += str(labels + 4) + ": iinc 0 0\n" +  t[7].code + "\n" + str(labels + 5) + ": iinc 0 0\n"
	labels = labels + 5
	t[0].next = str(labels)
	pass
